...
public enum DailyFortuneEngine {
    ...
    /// 전치(일진) 합충형파해 → 점수 가중치 (명리: 합=결합/안정, 충=변동, 형=갈등, 파=손상, 해=방해)
    static let relationWeight: [String: Int] = [
        "천간합": 6, "육합": 6,
        "천간충": -6, "육충": -8,
        "형": -7, "파": -4, "해": -5,
    ]

    /// 전치 합충형파해의 전반 점수 보정 — 일주(본인) 관계는 1.5배 가중, ±18로 클램프
    static func relationModifier(_ relations: [TransitRelation]) -> Int {
        var sum = 0.0
        for tr in relations {
            let mult = tr.natalPillar == "일주" ? 1.5 : 1.0
            for r in tr.stemRelations { sum += Double(relationWeight[r.type] ?? 0) * mult }
            for r in tr.branchRelations { sum += Double(relationWeight[r.type] ?? 0) * mult }
        }
        return max(-18, min(18, Int(sum.rounded())))
    }
    ...
    static let fortuneDescriptions: [String: [String: String]] = [
        "재물": ["상": "금전 기회가 열리는 흐름이에요. 좋은 제안이 오면 살펴보세요.", "중상": "재물운이 괜찮은 편이에요. 소소한 이익을 기대해도 좋아요.", "중": "무난한 재물 흐름이에요. 과소비만 살짝 조심해보세요.", "중하": "지출이 늘기 쉬운 편이에요. 조금 아껴 쓰면 좋겠어요.", "하": "돈 문제는 신중함이 필요한 흐름이에요. 큰 결정은 미뤄보세요."],
        "건강": ["상": "활력이 도는 흐름이에요. 운동이나 야외활동에 좋아요.", "중상": "전반적으로 컨디션이 괜찮은 편이에요.", "중": "무리만 안 하면 무난하게 보낼 수 있어요.", "중하": "피로가 쌓이기 쉬운 편이에요. 충분히 쉬어가요.", "하": "건강을 살뜰히 챙기면 좋은 흐름이에요. 무리는 피해보세요."],
        "연애": ["상": "설레는 인연이 가까워지는 흐름이에요.", "중상": "상대와 더 가까워지기 좋은 시기예요.", "중": "평온한 관계를 이어가기 좋은 편이에요.", "중하": "작은 오해가 생기기 쉬워요. 대화로 풀어보세요.", "하": "감정이 부딪치기 쉬운 흐름이에요. 한 발 물러서면 편해져요."],
        "직장": ["상": "성과를 내기 좋은 흐름이에요. 자신 있게 추진해보세요.", "중상": "일이 순조롭게 풀리는 편이에요.", "중": "꾸준히 하면 결과가 따라오는 흐름이에요.", "중하": "업무 부담이 느껴지기 쉬워요. 우선순위를 정해보세요.", "하": "동료와 마찰이 생기기 쉬운 흐름이에요. 신중하게 움직여요."],
        "학업": ["상": "집중이 잘 되는 흐름이에요. 새로 배우기 좋아요.", "중상": "학습 효율이 좋은 편이에요.", "중": "보통의 컨디션이에요. 가볍게 이어가보세요.", "중하": "집중이 흐트러지기 쉬워요. 환경을 바꿔보세요.", "하": "머리가 복잡해지기 쉬운 편이에요. 가벼운 복습이 알맞아요."],
        "대인": ["상": "새 인연을 맺기 좋은 흐름이에요. 먼저 다가가보세요.", "중상": "주변과 원만하게 지내기 좋은 편이에요.", "중": "무난한 관계의 흐름이에요.", "중하": "말이 오해를 부르기 쉬워요. 표현을 조금 다듬어보세요.", "하": "갈등이 생기기 쉬운 흐름이에요. 부딪침은 피해가요."],
        "여행": ["상": "이동·여행에 좋은 기운이 함께하는 흐름이에요.", "중상": "가벼운 나들이가 기분 전환이 되어줄 거예요.", "중": "일상적인 이동은 무난한 편이에요.", "중하": "이동 중 소소한 불편이 있을 수 있어요.", "하": "먼 이동은 조금 미뤄두면 좋겠어요."],
        "창작": ["상": "영감이 풍부한 흐름이에요. 창작에 몰입하기 좋아요.", "중상": "아이디어가 잘 떠오르는 편이에요.", "중": "꾸준한 작업이 결실로 이어지는 흐름이에요.", "중하": "창작 의욕이 살짝 가라앉기 쉬워요.", "하": "만들기보다 좋은 작품을 감상하며 충전해보세요."],
        "가정": ["상": "가족과 즐겁게 보내기 좋은 흐름이에요.", "중상": "집안에 온기가 도는 편이에요.", "중": "평화로운 하루가 이어지는 흐름이에요.", "중하": "가족 간 작은 마찰이 생기기 쉬워요.", "하": "가족에게 한 박자 여유를 두면 좋은 흐름이에요."],
        "투자": ["상": "판단이 밝은 흐름이에요. 좋은 기회를 살펴보세요.", "중상": "신중하게 접근하면 결과가 따라올 수 있어요.", "중": "현 상태를 지키는 편이 무난해요.", "중하": "보수적으로 접근하면 좋겠어요.", "하": "오늘은 투자를 잠시 쉬어가는 게 현명해요."],
    ]
    ...
    public static func calculateDailyFortune(
        ...
        // 전치 합충형파해 — 점수 가중치(relationMod)로 명시 반영 (natalPillars 있을 때만)
        ...
        let relationMod = relationModifier(transitRelations)

        var cards: [DailyFortuneCard] = []
        for cat in fortuneCategories {
            let base = 50 + stageBonus + (affinity[cat.key] ?? 0) + relationMod
