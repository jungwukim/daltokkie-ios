...
- **브랜치**: main
- **최신 빌드**: 성공 (2026-06-27, iPhone 16 Pro). 최근: **사주 상세 일목요연화**(명식표+신살·길성 표, DEC-018)·**홈 히어로 '오늘의 운세 한 줄' 하이브리드**(AI 한 줄 7일 캐시 + 규칙 폴백, DEC-017)·3개 상세 인스트루먼트 톤·다크모드·AI 연도 정확도·궁합 재설계
...
- **검증**: 빌드 ✅. TEMP로 인라인 달력·탭 상세(15일 "庚申·정재의 날·54점")·풀스크린(월 전환·범례) 렌더 확인 후 전부 원복
